...
export const Contact = ({modeTheme}: Props) => {
    ...
    return(
            ...
            <ContactWrapper id="contact">
                ...
                <Links>
                    <Link href="shiho-kazama-resume.pdf" download title={'Resume'}><TiDocument size={width > 768 ? '30px': '20px'}color={modeTheme === 'light' ? "#594a4e" : "#fffffe"} /></Link>
                    ...
                    <Link href="https://www.linkedin.com/in/shiho-kazama-659782230/" target="_blank" title={'LinkedIn'}><TiSocialLinkedinCircular size={width > 768 ? '40px': '25px'} color={modeTheme === 'light' ? "#594a4e" : "#fffffe"} /></Link>
