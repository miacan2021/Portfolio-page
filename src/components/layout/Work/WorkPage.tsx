...
export const WorkPage = () => {
  ...
  const colors: string[] =
    modeTheme === 'light'
      ? ['#ffc6c7', '#fffffe', '#c3f0ca', '#faeee7', '#ff8ba7']
      : ['#d4d8f0', '#fffffe', '#eebbc3', '#d4d8f0', '#d4939d']
    ...
    <>
      ...
      <ThemeProvider theme={modeTheme === 'light' ? theme : darkTheme}>
        ...
        <WorkPageWrapper>
          ...
          <CategoryWrapper>
            <CategoryBtn bg={btnBg.all} onClick={() => handleCategory('all')}>
              ALL
            </CategoryBtn>
            <CategoryBtn bg={btnBg.featured} onClick={() => handleCategory('Featured')}>
              FEATURED
            </CategoryBtn>
            <CategoryBtn bg={btnBg.fun} onClick={() => handleCategory('Fun')}>
              FUN / PRACTICE
            </CategoryBtn>
          </CategoryWrapper>
          <WorkCards>
            {datas.map((data, i) => {
              ...
              return <WorkCardWrapper key={data.title} color={color} data={data} direction={direction} />
            })}
          </WorkCards>
